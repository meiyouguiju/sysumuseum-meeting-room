...
public record UpdateBookingRequest(
        ...
        @NotNull(message = "roomId不能为空。") @Positive(message = "roomId必须为正整数。") Long roomId,
        @NotBlank(message = "subject不能为空。") @Size(max = 200, message = "subject长度不能超过200。") String subject,
        @NotNull(message = "startTime不能为空。") LocalDateTime startTime,
        @NotNull(message = "endTime不能为空。") LocalDateTime endTime,
